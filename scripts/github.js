...
var githubbadge = function() {
    ...
    var config = {
        ...
        //name of css
        styles: 'http://zgithubbadge.appspot.com/css/github.css',
    ...
    function init() {
       ...
       if(badge) {
          ...
          if(c.indexOf(config.triggerGit) !== -1) {
               ...
               //get repos as JSON from server GitHub
               var repos = "https://api.github.com/users/"+login+"/repos?sort=created&callback=githubbadge.seed2";

               //get user infor as JSON from server Github
               var info = "https://api.github.com/users/"+ login +"?callback=githubbadge.seed1"
